...
class ExprVisitor(StmtVisitor):
    ...
    def init_cfg(self, node):
        ...
        module_statements = self.visit(node.body)
    ...
    def return_handler(
        ...
        """
        if any(isinstance(node, ConnectToExitNode) for node in function_nodes):
    ...
    def visit_Call(self, node):
        ...
        if definition:
            ...
            if isinstance(definition.node, (ast.Function,ast.LocalFunction)):
                ...
                raise Exception('Definition was neither Function or ' +
