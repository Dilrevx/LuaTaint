...
from lua_parser import printers
from lua_parser.builder import Builder
from lua_parser.utils.visitor import *
...
def copy_location(new_node, old_node):
    """
    Copy source location (`line`, `start_char`, `stop_char`, `first_token`, and `last_token`
    attributes) from *old_node* to *new_node* if possible, and return *new_node*.
    """
    for attr in 'start_char', 'stop_char', 'first_token', 'last_token', 'line':
